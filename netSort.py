...
class NetSortMode(enum.IntFlag) :
	...
	# Output Data - Flag Style
	# 11|11 0|000| 000|0 00|00 0|000 : Bits 16-19
	OUT_DATA_MASK        = 0o3600000
	OUT_DATA_TRACK_SORT  = 0o0200000
	OUT_DATA_PACKETS     = 0o0400000
	OUT_DATA_BYTES       = 0o1000000
	OUT_DATA_EXTEND_01   = 0o2000000
	OUT_DATA_DEFAULT     = OUT_DATA_TRACK_SORT
	# Output Format - Value Style
	# 111|1 00|00 0|000| 000|0 00|00 0|000 : Bits 20-23
	OUT_FORMAT_MASK        = 0o74000000  # Bits 20-23
	OUT_FORMAT_HUMAN_ALIGN = 0o04000000
	OUT_FORMAT_TSV         = 0o10000000
	OUT_FORMAT_CSV         = 0o14000000
	OUT_FORMAT_JSON        = 0o20000000
	OUT_FORMAT_EXTEND_01   = 0o74000000
	OUT_FORMAT_DEFAULT     = OUT_FORMAT_TSV
	# Aliases
	USE_DEFAULTS = MODE_NONE
